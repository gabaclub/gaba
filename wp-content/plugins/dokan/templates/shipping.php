...
$dps_delivery_distance       = get_user_meta( $user_id, '_dps_delivery_distance', true );
        ...
        <article class="dokan-settings-area">
            ...
            <form method="post" id="shipping-form"  action="" class="dokan-form-horizontal">
                ...
                <div class="dokan-shipping-wrapper">
                    ...
                    <div class="dokan-form-group dokan-shipping-price dokan-shipping-add-product">
                        <label class="dokan-w4 dokan-control-label" for="dps_additional_product">
                            <?php _e( 'Delivery Distance', 'dokan' ); ?>
                            <span class="dokan-tooltips-help tips" title="<?php esc_attr_e( ' Delivery distance refers to the  distance upto where store provides delivery free of cost', 'dokan' ); ?>">
                                <i class="fa fa-question-circle"></i>
                            </span>
                        </label>

                        <div class="dokan-w5 dokan-text-left">
                            <input id="delivery_distance" value="<?php echo $dps_delivery_distance; ?>" name="dps_delivery_distance"  class="dokan-form-control" type="number" step="any" min="0" >
                            <i>*Delivery Distance Must be in miles</i>
                        </div>
                    </div>
