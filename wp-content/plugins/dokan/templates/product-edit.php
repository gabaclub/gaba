...
//$sp_data = maybe_unserialize( get_post_meta( $post_id) );
//print_r($sp_data);
//exit;
                    ...
                    <div class="dokan-product-edit-left">
                        ...
                        <div id="tab-container" class='tab-container'> <!-- Only required for left/right tabs -->
                            ...
                            <div id="tabs_container">
                                <div id="edit-product">
                                    ...
                                    <div class="dokan-clearfix">
                                        ...
                                        <div class="content-half-part">
                                            ...
                                            <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                                <div class="dokan-form-group">
                                ...
                                <div class="show_if_simple" id="product-specifications">
								 <?php
								 		//print('<pre>'.print_r($sp_data, true).'</pre>');
										//dokan_get_template_part( 'edit/specifications' );
										Dokan_Template_Specifications::render_specification($post_id);
								  ?>
