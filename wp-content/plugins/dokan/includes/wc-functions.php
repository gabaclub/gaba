...
add_action( 'wp_ajax_dokan_custom_specification', 'prefix_ajax_dokan_custom_specification' );
add_action( 'wp_ajax_nopriv_dokan_custom_specification', 'prefix_ajax_dokan_custom_specification' );

function prefix_ajax_dokan_custom_specification() {
	...
	$whHtml= Dokan_Template_Specifications::render_specification($dataSpec[2], get_product_category_by_id($dataSpec[0]));
	return $whHtml;
}
