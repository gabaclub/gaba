...
function listing_styles(){
	...
	// Google Web Fonts
	wp_register_style( 'google-web-font-automotive', "http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,800,400italic");
	...
	// Flexslider
	wp_register_style( 'selectbox', CSS_DIR . "jquery.selectbox.css");
	...
	// FancyBox
	wp_register_style( 'fancybox', CSS_DIR . "jquery.fancybox.css"); 
...
function listing_scripts(){
    ...
    wp_register_script('custom-masonry', JS_DIR . 'jquery.masonry.js', array(), false, true);
